...
##############################################
# Question 2: What is shown in Plot 1?
...
##############################################
# Question 6: Apart from the colors red and blue to draw the points, what is the main difference between Plot 3a and Plot 3b? Is Plot 3b more informative than Plot 3a?
...
##############################################
# Question 14: Plot 10 is very important to determine a result concerning the Actual data sets and the Null data sets. Other than showing colored points, what does one conclude from Plot 10 about the above analysis? 
