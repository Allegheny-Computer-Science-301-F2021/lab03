...
## Objectives
 1. *Gene expression analysis*: Students are given working R code in which a gene expression analysis has been completed. Students are to follow the code to be able to learn how to use the commands and to interpret its output.

 2. To enhance the understanding of the basic R functionality, including the use of R Studio and
